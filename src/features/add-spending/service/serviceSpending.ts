...
import { OPERATION_SPENDING } from 'shared/service/factory/constants';
...
class SpendingService implements ISpendingService {
    ...
    async addSpending( { spending,categorie } : IFormSpending) {
        ...
        const createdOperation =  this.factoryOperation.createOperation(OPERATION_SPENDING,spending,modifytedCategorie);
