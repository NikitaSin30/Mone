...
function ErrorModal(props: IError): React.ReactElement {
    const { onChangeActive, children } = props;
    ...
    return (
        <div className="flex flex-1 w-100 gap-4 flex-col  bg text-white bg-slate-900 py-6 px-8 rounded-md
        shadow-lg md:w-1/2" onClick={(e) => e.stopPropagation()}>
